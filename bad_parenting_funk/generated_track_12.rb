...
live_loop :extracted_samples do
	...
	sample samps, 6, start: 0.0, attack: 0.01, attack_level: 0.607, decay: 0.099, decay_level: 0.87, sustain: 1.501, sustain_level: 0.756, release: 0.132 if sleep_sample_6(idx)
	...
	sample samps, 8, start: 0.0, attack: 0.042, attack_level: 0.361, decay: 0.15, decay_level: 0.712, sustain: 1.549, sustain_level: 0.444, release: 0.0 if sleep_sample_8(idx)
	sample samps, 9, start: 0.0, attack: 0.001, attack_level: 0.397, decay: 0.176, decay_level: 0.341, sustain: 1.565, sustain_level: 0.444, release: 0.0 if sleep_sample_9(idx)
